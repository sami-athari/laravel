...
<div class="container mt-5">
    <h1 class="text-center mb-5 text-primary">Create Product</h1>
    ...
    <div class="card shadow-lg rounded-lg p-4">
        <form action="{{ route('admin.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-4">
                ...
                <small class="form-text text-muted">Upload the product image (JPEG, PNG).</small>
            </div>

            <div class="form-group mb-4">
                <label for="stock" class="font-weight-bold">Stock</label>
                <input type="number" name="stock" id="stock" class="form-control form-control-lg" required min="0">
            </div>

            <div class="d-flex justify-content-between">
                <button type="submit" class="btn btn-success btn-lg px-4 py-2">Create Product</button>
